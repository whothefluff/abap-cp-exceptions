...
class zcx_cp_static_check definition
                          public
  ...
  protected section.
    ...
    types: begin of _t_error,
           ...
           _t_errors type hashed table of zcx_cp_static_check=>_t_error with unique key old.
    ...
    methods _set_and_use_xco
              importing
                i_vars type symsg
              returning
                value(r_self) type ref to zcx_cp_static_check.

    class-data _errors type zcx_cp_static_check=>_t_errors.
...
endclass.
class zcx_cp_static_check implementation.
